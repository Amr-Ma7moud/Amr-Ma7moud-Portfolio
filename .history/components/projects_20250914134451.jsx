                  ...
                  <div className="relative bg-gray-900 rounded-xl overflow-hidden h-full">
                    ...
                    <div className="flex flex-col lg:flex-row min-h-[400px]">
                      ...
                      <div className="w-full lg:w-2/5 flex flex-col">
                        ...
                        <div className="flex-1 p-4 lg:p-6 bg-gray-800/50">
                          <div className="mb-4">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {project.tags.map((tag, tagIndex) => (
                                <span 
                                  key={tagIndex} 
                                  className="px-3 py-1 bg-purple-600/20 backdrop-blur-sm text-purple-300 rounded-full text-xs font-medium border border-purple-400/30 hover:bg-purple-600/30 transition-colors"
                                >
                                  {tag}
                                </span>
                              ))}
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex items-center text-xs text-gray-400">
                              ...
                              Type: {project.tags[0] || 'Web Application'}
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="w-full lg:w-3/5 p-6 lg:p-8 flex flex-col justify-between">
                          ...
                          <div className="mb-6">
                            ...
                            <ul className="space-y-2">
                              <li className="flex items-start text-gray-300">
                                ...
                                <span className="text-sm">Responsive cross-platform design</span>
                              </li>
                              <li className="flex items-start text-gray-300">
                                <span className="w-1.5 h-1.5 bg-purple-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                                <span className="text-sm">Modern user interface with smooth animations</span>
                              </li>
                              <li className="flex items-start text-gray-300">
                                <span className="w-1.5 h-1.5 bg-purple-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                                <span className="text-sm">Optimized performance and accessibility</span>
                              </li>
                            </ul>
                          </div>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-3 pt-6 border-t border-gray-700/50">
                          ...
                          {/* View details button */}
                          <button className="flex items-center gap-2 px-4 py-2 bg-gray-700 text-gray-300 hover:text-white hover:bg-gray-600 transition-colors rounded-lg text-sm font-medium ml-auto">
