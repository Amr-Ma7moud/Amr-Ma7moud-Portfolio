          ...
          <nav className="hidden md:flex items-center space-x-8">
            {navLinks.map((link) => {
              ...
              return (<div key={link.id}>
                <Link href={link.href} className={`text-gray-300 hover:text-white transition-colors relative group ${isActive ? "bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent" : ""
                  }
                  `}>
                  {link.name}
