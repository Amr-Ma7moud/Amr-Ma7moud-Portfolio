                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                        ...
                        <div className="order-2 lg:order-1 flex flex-col items-center" data-aos="fade-right" >
                            ...
                            <div className="relative mb-8">
                                ...
                                <div className="relative bg-gray-800 bg-opacity-80 backdrop-blur-lg rounded-2xl p-2 border border-gray-700 shadow-xl overflow-hiddenhover:scale-105 transition-all"
                                >
                                    <img
                                        src="/mypic.jpeg"
                                        alt="Amr Mahmoud"
                                        className="w-full max-w-xl object-cover rounded-2xl border-4 border-purple-600 shadow-lg"
                                    />
                                </div>
                            </div>
