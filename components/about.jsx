...
const contactLinks = [
    {
        ...
        innerText: "Amr.Mahmoud.Dev05@gmail.com",
        catagory: "Email",
    },
    {
        name: FaWhatsapp,
        href: "https://wa.me/+201033050549",
        innerText: "+201033050549",
        catagory: "Phone",
    },
    {
        name: FaLinkedin,
        href: "https://www.linkedin.com/in/amr-mahmoud-/",
        innerText: "Amr Mahmoud",
        catagory: "LinkedIn",
    },
    {
        name: FaGithub,
    ...
    },
    {
        name: MapPin,
        href: "",
        innerText: "Borg Al-Arab, Alexandria, Egypt",
        catagory: "Location",
    },
    {
        name: FaClock,
        href: "",
        innerText: "Usually Within 24 hours",
        catagory: "Response Time",
    },
];
...
export default function About() {
    ...
    return (
        <section
            id="about"
            className="py-20 min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 relative overflow-hidden w-full max-w-full"
        >
            ...
            <div className="absolute inset-0 -z-10 overflow-hidden">
                ...
                <div
                    className="absolute top-32 right-32 w-80 h-80 bg-indigo-500 rounded-full filter blur-2xl opacity-15"
                    style={{ animation: "pulse 6s ease-in-out infinite 1s" }}
                ></div>
                <div
                    className="absolute bottom-40 left-32 w-64 h-64 bg-pink-500 rounded-full filter blur-2xl opacity-20"
            ...
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                ...
                >
                    ...
                    >
                        <h2 className="text-xs sm:text-sm uppercase tracking-wider text-purple-500 mb-2">
                            Get To Know Me
                        </h2>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                        ...
                        >
                            ...
                            <p className="text-gray-300 mb-6 sm:mb-8 text-base sm:text-lg leading-relaxed">
                                ...
                                and competitive programming. Skilled in
                                developing cross-platform applications using
                                Python, JavaScript, and modern frameworks
                                including Flask and Laravel. Fast learner,
                                adaptable, detail-oriented, and able to work
                                well in team environments, with a focus on
                            ...
                            <div className="flex flex-col gap-6 mb-10">
                                {contactLinks
                                    .filter((link) =>
                                        [MdEmail, MapPin].includes(link.name),
                                    )
                                    .map((link, index) => (
                                        <div
                                            key={`about-contact-${index}`}
                                            className="flex items-center gap-3 bg-gray-600 bg-opacity-50 p-4 rounded-lg border border-gray-700 transition-all hover:bg-purple-600 hover:text-white"
                                        >
                                            {React.createElement(link.name, {
