                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <div className="mb-10">
                            ...
                            <div className="rounded-lg overflow-hidden h-48 border border-gray-800">
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d52129.91253415919!2d29.496587364522767!3d30.91447711426634!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14f5870463d09481%3A0xa8c0f90c90babfc4!2sMadinet%20Borg%20Al%20Arab%2C%20Borg%20El%20Arab%2C%20Alexandria%20Governorate%2C%20Egypt!5e1!3m2!1sen!2sus!4v1756719099810!5m2!1sen!2sus"
                                    width="100%"
                                    height="100%"
                                    style={{ border: 0 }}
                                    ...
                                    title="Borg Al-Arab, Alexandria, Egypt Map"
                                ></iframe>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-xl">
                            ...
                            <div>
                                <h3 className="text-xl font-semibold mt-4 mb-4">Follow Me</h3>
